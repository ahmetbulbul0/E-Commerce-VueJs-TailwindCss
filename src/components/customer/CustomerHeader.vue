            ...
            <div class="flex items-center space-x-4">
                ...
                <div class="relative">
                    ...
                    <NotificationsList
                        ...
                        all-notifications-route="/customer/notifications"
                ...
                <div class="relative">
                    ...
                    <div v-if="isProfileMenuOpen" class="absolute right-0 mt-2 w-48 rounded-lg border bg-card py-1 shadow-lg">
                        ...
                        <router-link :to="{ name: 'customer-settings' }" class="flex items-center px-4 py-2 text-sm text-muted-foreground hover:bg-accent hover:text-foreground">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="mr-2">
