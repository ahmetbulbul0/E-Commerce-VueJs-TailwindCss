<template>
  <div class="fixed right-0 top-1/2 z-50 -translate-y-1/2" :class="className">
    ...
    <button
      type="button"
      class="absolute -left-12 flex h-12 w-12 items-center justify-center rounded-l-lg bg-zinc-800 text-white hover:bg-zinc-700"
      @click="togglePanel"
    >
      <svg
        class="h-6 w-6"
    ...
    <!-- Panel -->
    <div
      class="w-80 transform bg-zinc-800 p-6 shadow-xl transition-transform"
      ...
      <div class="space-y-6">
        ...
        <div class="space-y-4">
          ...
          <div class="flex items-center gap-4">
            <button
              type="button"
              class="rounded-lg bg-zinc-700 p-2 text-white hover:bg-zinc-600"
        ...
        <div class="space-y-4">
          ...
          <div class="grid grid-cols-6 gap-2">
            <button
              ...
              :class="{ 'ring-2 ring-white': primaryColor === color }"
        ...
        <button
          type="button"
          class="w-full rounded-lg bg-zinc-700 px-4 py-2 text-sm text-white hover:bg-zinc-600"
          @click="resetSettings"
        >
