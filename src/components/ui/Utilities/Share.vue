<template>
    <div class="flex items-center space-x-2">
        ...
        <Dropdown position="right">
            <template #trigger>
                <button class="inline-flex items-center space-x-2 rounded-lg bg-zinc-800 px-4 py-2 text-sm font-medium text-white hover:bg-zinc-700">
            ...
            <DropdownItem @click="share('twitter')">
                <template #icon>
            ...
            <DropdownItem @click="share('facebook')">
                <template #icon>
            ...
            <DropdownItem @click="share('linkedin')">
                <template #icon>
            ...
            <DropdownItem @click="share('whatsapp')">
                <template #icon>
                    <svg class="h-5 w-5 text-[#25D366]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                        <path
        ...
        <div v-if="showQuickShare" class="flex space-x-2">
            <button v-for="platform in quickSharePlatforms" :key="platform.name" @click="share(platform.name)" class="inline-flex items-center justify-center rounded-lg p-2 hover:bg-zinc-700" :title="`${platform.label}'de Paylaş`">
                <component :is="platform.icon" :class="[platform.iconClass, 'h-5 w-5']" />
            </button>
        </div>
    </div>
</template>
