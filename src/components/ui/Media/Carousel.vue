  ...
  <div class="relative" :class="className">
    ...
    <div class="relative overflow-hidden rounded-lg">
      ...
      >
        ...
        >
          ...
          <div
            v-if="slide.caption"
            class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/75 to-transparent p-4"
          >
      ...
      <button
        ...
        class="absolute left-4 top-1/2 -translate-y-1/2 rounded-full bg-black/50 p-2 text-white backdrop-blur-sm transition-all hover:bg-black/75"
        @click="prev"
      >
      ...
      <button
        v-if="showArrows && slides.length > 1"
        class="absolute right-4 top-1/2 -translate-y-1/2 rounded-full bg-black/50 p-2 text-white backdrop-blur-sm transition-all hover:bg-black/75"
        @click="next"
      >
        <svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path
    ...
    >
      <button
        v-for="(slide, index) in slides"
        :key="index"
        class="relative flex-shrink-0 overflow-hidden rounded-lg focus:outline-none"
