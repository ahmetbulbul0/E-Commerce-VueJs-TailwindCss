    ...
    <div class="orders-container max-w-5xl mx-auto p-6">
        ...
        <div class="space-y-4">
            <div
                ...
                :key="order.id"
                class="bg-card rounded-lg border border-border overflow-hidden hover:border-primary/50 transition-colors"
            >
                <!-- Sipariş Başlığı -->
                    ...
                    <div class="flex flex-wrap gap-4">
                        ...
                        <div class="flex -space-x-3">
                            <img
                                ...
                                :src="product.image"
                                :alt="product.name"
                                class="w-12 h-12 rounded-lg border-2 border-background object-cover"
                            />
                            <div
                                v-if="order.products.length > 3"
                                class="w-12 h-12 rounded-lg bg-primary/10 border-2 border-background flex items-center justify-center text-sm font-medium text-primary"
                            >
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <div class="flex items-center space-x-2">
                                    ...
                                    <router-link
                                        ...
                                        v-if="
                                            order.status === 'delivered' && !order.isReturnExpired
                                        "
        ...
        <div v-if="filteredOrders.length === 0" class="text-center py-12">
            ...
            <p class="text-muted-foreground mt-2">
                Seçili filtrelerle eşleşen sipariş bulunmamaktadır.
            </p>
        </div>
        ...
        return {
            ...
            orders: [
                ...
                },
                {
                    ...
                    status: 'delivered',
                    products: [
                        { id: 7, name: 'Ürün 7', image: 'https://picsum.photos/200/200?random=7' },
                    ],
                    total: 199.9,
                    isReturnExpired: false,
                },
