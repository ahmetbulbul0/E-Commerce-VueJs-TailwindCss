      ...
      <div class="container py-6">
        ...
        <div class="mt-6">
          <div v-if="addresses.length === 0" class="text-center py-12">
            <div
              class="rounded-full bg-primary/10 p-3 text-primary w-12 h-12 mx-auto mb-4 flex items-center justify-center"
            >
              <svg
            ...
            <p class="text-sm text-muted-foreground mb-4">
              Siparişlerinizin teslimatı için en az bir adres eklemelisiniz.
            </p>
            <Button @click="showAddAddressModal = true">Yeni Adres Ekle</Button>
          </div>
            ...
            >
              <div class="flex items-start justify-between">
                ...
                <div class="flex items-center space-x-2">
                  ...
                  <button
                    class="rounded-full p-2 hover:bg-muted text-destructive"
