                ...
                <form class="space-y-6" @submit.prevent="handleSubmit">
                    ...
                    <div class="space-y-2">
                        ...
                        <p class="text-xs text-muted-foreground">
                            Size özel kampanyalardan haberdar olmak için e-posta adresinizi girin.
                        </p>
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            ...
                            <button 
                                ...
                                @mouseleave="showPasswordConfirm = false"
                            >
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                    <path d="M2 12s3-7 10-7 10 7 10 7-3 7-10 7-10-7-10-7Z"/>
                                    <circle cx="12" cy="12" r="3"/>
                    ...
                    <div class="space-y-4">
                        ...
                        >
                            <span class="text-sm text-muted-foreground">
                                <router-link to="/terms" class="font-medium text-foreground hover:text-primary">Kullanım Koşulları</router-link>'nı ve
                                <router-link to="/privacy" class="font-medium text-foreground hover:text-primary">Gizlilik Politikası</router-link>'nı okudum ve kabul ediyorum.
                            </span>
                        </Checkbox>
                    ...
                    <div class="space-y-6">
                        <button
                            ...
                            :disabled="loading || !form.terms || !isPasswordMatch"
                        >
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <button
                                type="button"
                                class="flex w-full items-center justify-center gap-2 rounded-md bg-card px-3 py-2 text-sm font-semibold text-card-foreground shadow-sm ring-1 ring-inset ring-input hover:bg-accent transition-colors"
                            ...
                            <button
                                type="button"
                                class="flex w-full items-center justify-center gap-2 rounded-md bg-[#1877F2] px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-[#1877F2]/90 transition-colors"
...
const passwordStrengthText = computed(() => {
    switch (passwordStrength.value) {
        case 0: return 'Şifreniz çok zayıf'
        case 1: return 'Şifreniz zayıf'
        case 2: return 'Şifreniz orta'
        case 3: return 'Şifreniz güçlü'
        case 4: return 'Şifreniz çok güçlü'
        default: return ''
    }
})
