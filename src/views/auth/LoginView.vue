            ...
            <div class="bg-card px-6 py-12 shadow-lg sm:rounded-lg sm:px-12">
                <form class="space-y-6" @submit.prevent="handleSubmit">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <router-link to="/forgot-password" class="text-sm font-medium text-primary hover:text-primary/90">
                                Şifremi Unuttum
                            </router-link>
                        </div>
                    </div>
                ...
                <div class="mt-6">
                    ...
                    <div class="mt-6">
                        <router-link
                            to="/register"
                            class="flex w-full justify-center rounded-md bg-card px-3 py-2 text-sm font-semibold text-card-foreground shadow-sm ring-1 ring-inset ring-input hover:bg-accent transition-colors h-11 items-center"
                        >
                            Hesap Oluştur
                        </router-link>
                    </div>
