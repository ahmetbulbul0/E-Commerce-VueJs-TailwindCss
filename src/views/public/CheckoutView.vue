        ...
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-12">
            ...
            <div class="lg:col-span-8">
                <form @submit.prevent="handleSubmit" class="space-y-6">
                    ...
                    <Card>
                        ...
                        <div class="p-6">
                            <div class="space-y-4">
                                <div v-for="(company, index) in shippingCompanies" :key="index" 
                                    class="flex items-center justify-between p-4 rounded-lg border hover:border-primary/50 transition-colors cursor-pointer bg-card" 
                                    :class="{ 'border-primary bg-primary/5': form.shippingCompany === company.id }" 
                                    @click="form.shippingCompany = company.id">
                            ...
                            <div class="grid gap-4 sm:grid-cols-2">
                                ...
                                <div class="relative">
                                    ...
                                    <button 
                                        ...
                                        @mousedown="showCVV = true"
                                        @mouseup="showCVV = false"
                                        @mouseleave="showCVV = false"
                                    >
            ...
            <div class="lg:col-span-4">
                <div class="sticky top-8 space-y-6">
                    ...
                    <button
                        type="submit"
                        class="w-full flex items-center justify-center space-x-2 bg-primary text-primary-foreground h-12 px-8 rounded-md hover:bg-primary/90 transition-colors disabled:opacity-50 disabled:cursor-not-allowed text-base font-medium"
                        :disabled="loading"
                        @click="handleSubmit"
                    >
