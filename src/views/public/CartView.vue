  ...
  <div class="container py-8">
    ...
    <div v-else-if="cartItems.length === 0" class="rounded-lg border bg-card p-8 text-center">
      ...
      <p class="text-sm text-muted-foreground">
        Sepetinizde henüz ürün bulunmuyor. Alışverişe başlamak için ürünler sayfasını ziyaret edin.
      </p>
      <div class="mt-6">
      ...
      <div class="lg:col-span-8">
        <div class="rounded-lg border bg-card">
          <div
            ...
            :key="item.id"
            class="flex items-start space-x-4 border-b p-6 last:border-0"
          >
            <!-- Ürün Görseli -->
              ...
              <div class="mt-4 flex items-center justify-between">
                ...
                <div class="flex items-baseline space-x-2">
                  <span class="text-lg font-bold"
                    >{{ (item.price * item.quantity).toFixed(2) }} TL</span
                  >
                  <span v-if="item.oldPrice" class="text-sm text-muted-foreground line-through">
                    {{ (item.oldPrice * item.quantity).toFixed(2) }} TL
                  </span>
                </div>
              </div>
            </div>
      ...
      <div class="lg:col-span-4">
        <div class="sticky top-8 rounded-lg border bg-card p-6">
          ...
          <div class="mt-6 space-y-4">
            ...
            <Button variant="outline" class="w-full" @click="applyCoupon">
