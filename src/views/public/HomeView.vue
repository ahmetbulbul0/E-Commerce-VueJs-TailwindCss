        ...
        <section class="py-12 md:py-16 border-t">
            <div class="container space-y-8">
                ...
                <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                    <div class="group relative overflow-hidden rounded-lg border bg-background">
                        ...
                        <div class="p-4">
                            ...
                            <p class="mt-1 text-sm text-muted-foreground">
                                Seçili yaz ürünlerinde %50'ye varan indirimler
                            </p>
                    ...
                    <div
                        class="group relative overflow-hidden rounded-lg border bg-background lg:col-span-1 md:col-span-2 lg:col-span-1"
                    >
                        <div class="aspect-[16/9] overflow-hidden">
                            <img
                                src="https://images.unsplash.com/photo-1607083206869-4c7672e72a8a?w=800&h=450&fit=crop"
                                alt="Süper Fırsat"
                                class="h-full w-full object-cover transition-transform duration-300 group-hover:scale-105"
                            />
                        </div>
            ...
            <div class="container space-y-8">
                <div class="flex flex-col items-center space-y-2">
                    ...
                    <p class="text-muted-foreground">
                        İhtiyacınız olan her şey kategorilere ayrılmış şekilde
                    </p>
                </div>
